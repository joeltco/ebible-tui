...
## Quick Install (Termux)
    ...
    pip install --upgrade pip && pip install "textual==0.58.1" "rich==13.7.1" "pyyaml"
...
## Quick Install (Debian/Ubuntu)
    ...
    pip3 install "textual==0.58.1" "rich==13.7.1" "pyyaml"
...
## Optional: one-time launcher (no venv)
    ...
    python3 -c "import textual,rich,yaml" 2>/dev/null || pip3 install textual==0.58.1 rich==13.7.1 pyyaml >/dev/null
...
## Launcher
To run prayer mode from anywhere:
```bash
~/bin/ebible
```
